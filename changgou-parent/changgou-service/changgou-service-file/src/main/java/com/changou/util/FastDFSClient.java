...
public class FastDFSClient {
    ...
    public static String[] upload(FastDFSFile file) {
        ...
        try {
             ...
             */
            /**
             * 通过StorsgeClient访问Stroage，实现文件上传，并且获取文件上传后的存储信息
             * 1.上传文件的字节数组
             * 2.文件的扩展名 jpg
             * 3。附加参数 比如：北京
             */
    ...
    public static void main(String[] args) throws Exception {
        FileInfo group1 = getFile("group1", "M00/00/00/wKgBb16Jia2ATNKlAAMHs6YSX5U413.jpg");
...
//        deleteFile("group1","M00/00/00/wKgBb16Jm7GAP0nrEaUc0Ky5Mzc133.mp4");
        StorageServer[] group1s1 = getStoreStorages("group1");
        for (StorageServer storageServer : group1s1) {
